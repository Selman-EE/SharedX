...
namespace SharedX.Benchmarks
{
    ...
    public class StringEqualsBenchmark
    {
        ...
        private const string LongString1 = "This is a much longer string with more content to compare including Polish characters like Łódź and Kraków";
        private const string LongString2 = "THIS IS A MUCH LONGER STRING WITH MORE CONTENT TO COMPARE INCLUDING POLISH CHARACTERS LIKE ŁÓDŹ AND KRAKÓW";
        ...
        public bool Short_MemoryEquals()
        {
            if (ShortString1 == null && ShortString2 == null) return true;
            if (ShortString1 == null || ShortString2 == null) return false;
            return MemoryExtensions.Equals(ShortString1.AsSpan(), ShortString2.AsSpan(), StringComparison.OrdinalIgnoreCase);
        }
        ...
        public bool Medium_MemoryEquals()
        {
            if (MediumString1 == null && MediumString2 == null) return true;
            if (MediumString1 == null || MediumString2 == null) return false;
            return MemoryExtensions.Equals(MediumString1.AsSpan(), MediumString2.AsSpan(), StringComparison.OrdinalIgnoreCase);
        }
        ...
        public bool Long_MemoryEquals()
        {
            if (LongString1 == null && LongString2 == null) return true;
            if (LongString1 == null || LongString2 == null) return false;
            return MemoryExtensions.Equals(LongString1.AsSpan(), LongString2.AsSpan(), StringComparison.OrdinalIgnoreCase);
        }
